...
def get_future_date_results(
    ...
    print(type(sqlighter3_Si_day.get_max_date_futures(connection, cursor)))
    print(type(today_date))

    end_date = datetime.strptime(sqlighter3_Si_day.get_max_date_futures(connection, cursor), "%Y-%m-%d").date()
    ...
    if end_date != today_date:
        ...
        sqlighter3_Si_day.add_tradedate_future(
            ...
            # today_date
            sqlighter3_Si_day.get_max_lsttrade(connection, cursor)
            )
